...
export const basicGauges = {
  users: new client.Gauge({
    name: "librechat_user_count",
    help: "Total number of users",
  }),
  actions: new client.Gauge({
    name: "librechat_action_count",
    help: "Total number of actions",
  }),
  agents: new client.Gauge({
    name: "librechat_agent_count",
    help: "Total number of agents",
  }),
  assistants: new client.Gauge({
    name: "librechat_assistant_count",
    help: "Total number of assistants",
  }),
  balances: new client.Gauge({
    name: "librechat_balance_count",
    help: "Total number of balance records",
  }),
  banners: new client.Gauge({
    name: "librechat_banner_count",
    help: "Total number of banners",
  }),
  conversationTags: new client.Gauge({
    name: "librechat_conversation_tag_count",
    help: "Total number of conversation tags",
  }),
  conversations: new client.Gauge({
    name: "librechat_conversation_count",
    help: "Total number of conversations",
  }),
  files: new client.Gauge({
    name: "librechat_file_count",
    help: "Total number of files",
  }),
  keys: new client.Gauge({
    name: "librechat_key_count",
    help: "Total number of keys",
  }),
  messages: new client.Gauge({
    name: "librechat_message_count",
    help: "Total number of messages",
  }),
  pluginAuth: new client.Gauge({
    name: "librechat_plugin_auth_count",
    help: "Total number of plugin auth records",
  }),
  presets: new client.Gauge({
    name: "librechat_preset_count",
    help: "Total number of presets",
  }),
  promptGroups: new client.Gauge({
    name: "librechat_prompt_group_count",
    help: "Total number of prompt groups",
  }),
  prompts: new client.Gauge({
    name: "librechat_prompt_count",
    help: "Total number of prompts",
  }),
  sessions: new client.Gauge({
    name: "librechat_session_count",
    help: "Total number of sessions",
  }),
  sharedLinks: new client.Gauge({
    name: "librechat_shared_link_count",
    help: "Total number of shared links",
  }),
  tokens: new client.Gauge({
    name: "librechat_token_count",
    help: "Total number of tokens",
  }),
  toolCalls: new client.Gauge({
    name: "librechat_tool_call_count",
    help: "Total number of tool calls",
  }),
  transactions: new client.Gauge({
    name: "librechat_transaction_count",
